...
description: Coordinate frontend, backend, QA, and analyzer work across the monorepo — split tracks, enforce shared contracts, resolve blockers, and keep changes aligned.
---
