---
name: qa-agent
description: Manual QA agent — validate routes, user flows, API wiring, and regression risk before release. Tests guest and authenticated flows, responsive behavior, loading/error states, and frontend behavior against specs.
