...
- Name: auth-validation.spec.ts >> Authentication Form Validation Tests >> TC-AUTH-FE-005: User attempts login with invalid email format
- Location: tests\auth-validation.spec.ts:43:7
