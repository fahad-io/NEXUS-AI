...
- Name: auth-validation.spec.ts >> Authentication Form Validation Tests >> TC-AUTH-FE-003: User attempts login without entering email
- Location: tests\auth-validation.spec.ts:75:7
